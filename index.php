    ...
    <div class="container" style="padding-top:150px">
        <div class="row" style="background-color: rgb(82,183,136); text-align: center;">
            <div class="col" style="background-color: rgb(116,198,157);">
                <img src="Cliente/img/logo.jpg" width="350px" height="350px" style="padding-top: 20px;">
            </div>
            <div class="col" style="background-color: rgb(183,213,178);">
                
                <h1 style="color: #2a1611">DENISSE PEREZ BOTELLO</h1>
                <h1 style="color: #2a1611">HOLA</h1>
                ...
                <form style="padding: 15px;" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailHelp" class="form-text">No olvides colocar tu correo electronico.
                        </div>
                    </div>
                    <div class="mb-3">
